tellraw @a "\n------------------------------------\n"
tellraw @a [{"translate":"%s×%s__ver_1.2 made by %s","with":[{"text":"Minecraft","color":"dark_green","bold":true},{"text":"DeathNote","color":"dark_red","bold":true},{"text":"Soukun_Palpunte","color":"gold","bold":false}]}]
